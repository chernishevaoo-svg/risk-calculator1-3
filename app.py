...
st.title("🏥 Оценка риска летального исхода в течение первых трех суток госпитализации у пациентов с бактериальными менингитами")
...
if st.button("Рассчитать риск", type="primary", use_container_width=True):
    ...
    if probability < config['prob_low']:
        ...
        bg_color = "#f8d7da"
        text_color = "#721c24"
        recommendation = "Рекомендуется госпитализация в ОРИТ и проведение интенсивной терапии."
    else:
